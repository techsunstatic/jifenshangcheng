 ...
 */
! function (a, b) {
  "function" == typeof define && define.amd ? define(["jquery", "doT", "jQuery.extendext"], b) : b(a.jQuery, a.doT)
}(this, function ($, a) {
  "use strict";
  ...
  function e(a, b, c) {
    ...
    d = b.closest(f.rule_container), d.length && (e = "moveAfter"), e || (d = b.closest(f.group_header), d.length && (d = b.closest(f.group_container), e = "moveAtBegin")), e || (d = b.closest(f.group_container), d.length && (e = "moveAtEnd")), e && (a[e](c.getModel(d)), c && a instanceof j && c.setRuleInputValue(a, a.value))
  }
  ...
  var g = function (c, d) {
    ...
    }, this.filters = this.settings.filters, this.icons = this.settings.icons, this.operators = this.settings.operators, this.templates = this.settings.templates, this.plugins = this.settings.plugins, this.lang = null, void 0 === g.regional.en && k.error("Config", '"i18n/en.js" not loaded.'), this.lang = $.extendext(!0, "replace", {}, g.regional.en, g.regional[this.settings.lang_code], this.settings.lang), this.settings.allow_groups === !1 ? this.settings.allow_groups = 0 : this.settings.allow_groups === !0 && (this.settings.allow_groups = -1), Object.keys(this.templates).forEach(function (b) {
  ...
  $.extend(g.prototype, {
      ...
      if (this.plugins) {
        ...
        Object.keys(this.plugins).forEach(function (a) {
          a in g.plugins ? (this.plugins[a] = $.extend(!0, {}, g.plugins[a].def, this.plugins[a] || {}), g.plugins[a].fct.call(this, this.plugins[a])) : k.error("Config", 'Unable to find plugin "{0}"', a)
        }, this)
      }
    }, g.prototype.checkFilters = function (a) {
      var b = [];
      if (a && 0 !== a.length || k.error("Config", "Missing filters list"), a.forEach(function (a, c) {
          switch (a.id || k.error("Config", "Missing filter {0} id", c), b.indexOf(a.id) != -1 && k.error("Config", 'Filter "{0}" already defined', a.id), b.push(a.id), a.type ? g.types[a.type] || k.error("Config", 'Invalid type "{0}"', a.type) : a.type = "string", a.input ? "function" != typeof a.input && g.inputs.indexOf(a.input) == -1 && k.error("Config", 'Invalid input "{0}"', a.input) : a.input = "number" === g.types[a.type] ? "number" : "text", a.operators && a.operators.forEach(function (a) {
            "string" != typeof a && k.error("Config", "Filter operators must be global operators types (string)")
            ...
            case "radio":
            case "checkbox":
              (!a.values || a.values.length < 1) && k.error("Config", 'Missing filter "{0}" values', a.id);
              break;
            case "select":
              a.placeholder && (void 0 === a.placeholder_value && (a.placeholder_value = -1), k.iterateOptions(a.values, function (b) {
                b == a.placeholder_value && k.error("Config", 'Placeholder of filter "{0}" overlaps with one of its values', a.id)
              }))
          }
      ...
      return this.status.has_optgroup && (a = k.groupSort(a, "optgroup")), a
      ...
      }, this), this.status.has_operator_optgroup && (a = k.groupSort(a, "optgroup")), a
      ...
      a = a || this.model.root, a && (a.error = null, a instanceof i && a.each(function (a) {
        a.error = null
      }, function (a) {
        this.clearErrors(a)
      }, this))
      ...
      if (this.settings.display_errors)
        if (null === a.error) a.$el.removeClass("has-error");
          ...
          b = k.fmt(b, a.error.slice(1)), b = this.change("displayError", b, a.error, a), a.$el.addClass("has-error").find(g.selectors.error_container).eq(0).attr("title", b)
        }
      ...
      return a ? a instanceof h ? a : $(a).data("queryBuilderModel") : this.model.root
      ...
      var b = this,
        c = function d(c) {
          ...
          return c.each(function (c) {
            ...
            var b = d(a);
            b === !0 ? e++ : b === !1 && f++
          }), !(f > 0) && (0 === e && !c.isRoot() && a.skip_empty ? null : !!(0 !== e || b.settings.allow_empty && c.isRoot()) || (b.triggerValidationError(c, "empty_group", null), !1))
        }(this.model.root);
      ...
      b = $.extend({
        ...
        rules: a
      }), a && a.rules && (0 !== a.rules.length || this.settings.allow_empty) || k.error("RulesParse", "Incorrect data object passed"), this.clear(), this.setRoot(!1, a.data, this.parseGroupFlags(a)), this.applyGroupFlags(this.model.root), a = this.change("setRules", a, b);
      var c = this;
      ! function d(a, e) {
        null !== e && (void 0 === a.condition ? a.condition = c.settings.default_condition : c.settings.conditions.indexOf(a.condition) == -1 && (k.error(!b.allow_invalid, "UndefinedCondition", 'Invalid condition "{0}"', a.condition), a.condition = c.settings.default_condition), e.condition = a.condition, a.rules.forEach(function (a) {
          var f;
          if (void 0 !== a.rules)
            if (c.settings.allow_groups !== -1 && c.settings.allow_groups < e.level) k.error(!b.allow_invalid, "RulesParse", "No more than {0} groups are allowed", c.settings.allow_groups), c.reset();
            else {
              if (f = c.addGroup(e, !1, a.data, c.parseGroupFlags(a)), null === f) return;
              c.applyGroupFlags(f), d(a, f)
            }
          else {
            if (a.empty || (void 0 === a.id && (k.error(!b.allow_invalid, "RulesParse", "Missing rule field id"), a.empty = !0), void 0 === a.operator && (a.operator = "equal")), f = c.addRule(e, a.data, c.parseRuleFlags(a)), null === f) return;
            a.empty || (f.filter = c.getFilterById(a.id, !b.allow_invalid), f.filter && (f.operator = c.getOperatorByType(a.operator, !b.allow_invalid), f.operator || (f.operator = c.getOperators(f.filter)[0]), f.operator && 0 !== f.operator.nb_inputs && void 0 !== a.value && (f.value = a.value))), c.applyRuleFlags(f), c.change("jsonToRule", f, a) != f && k.error("RulesParse", "Plugin tried to change rule reference")
          }
        }), c.change("jsonToGroup", e, a) != e && k.error("RulesParse", "Plugin tried to change group reference"))
      ...
      for (var j = 0; j < f.nb_inputs; j++) {
        if (!f.multiple && $.isArray(b[j]) && b[j].length > 1) {
          i = ["operator_not_multiple", f.type, this.translate("operators", f.type)];
          break
        }
        switch (e.input) {
          case "radio":
            if (void 0 === b[j] || 0 === b[j].length) {
              h.allow_empty_value || (i = ["radio_empty"]);
              break
            }
            break;
          case "checkbox":
            if (void 0 === b[j] || 0 === b[j].length) {
              h.allow_empty_value || (i = ["checkbox_empty"]);
              break
            }
            break;
          case "select":
            if (void 0 === b[j] || 0 === b[j].length || e.placeholder && b[j] == e.placeholder_value) {
              h.allow_empty_value || (i = ["select_empty"]);
              break
            }
            break;
          default:
            d = $.isArray(b[j]) ? b[j] : [b[j]];
            for (var l = 0; l < d.length; l++) {
              switch (g.types[e.type]) {
                case "string":
                  if (void 0 === d[l] || 0 === d[l].length) {
                    h.allow_empty_value || (i = ["string_empty"]);
                    break
                  }
                  if (void 0 !== h.min && d[l].length < parseInt(h.min)) {
                    i = [this.getValidationMessage(h, "min", "string_exceed_min_length"), h.min];
                    break
                  }
                  if (void 0 !== h.max && d[l].length > parseInt(h.max)) {
                    i = [this.getValidationMessage(h, "max", "string_exceed_max_length"), h.max];
                    break
                  }
                  if (h.format && ("string" == typeof h.format && (h.format = new RegExp(h.format)), !h.format.test(d[l]))) {
                    i = [this.getValidationMessage(h, "format", "string_invalid_format"), h.format];
                    break
                  }
                  break;
                case "number":
                  if (void 0 === d[l] || 0 === d[l].length) {
                    h.allow_empty_value || (i = ["number_nan"]);
                    break
                  }
                  if (isNaN(d[l])) {
                    i = ["number_nan"];
                  ...
                  if (void 0 !== h.min && d[l] < parseFloat(h.min)) {
                    i = [this.getValidationMessage(h, "min", "number_exceed_min"), h.min];
                    break
                  }
                  if (void 0 !== h.max && d[l] > parseFloat(h.max)) {
                    i = [this.getValidationMessage(h, "max", "number_exceed_max"), h.max];
                    break
                  }
                  if (void 0 !== h.step && "any" !== h.step) {
                    var m = (d[l] / h.step).toPrecision(14);
                    if (parseInt(m) != m) {
                      i = [this.getValidationMessage(h, "step", "number_wrong_step"), h.step];
                      break
                    }
                  }
                  break;
                case "datetime":
                  if (void 0 === d[l] || 0 === d[l].length) {
                    h.allow_empty_value || (i = ["datetime_empty"]);
                    break
                  }
                  if (h.format) {
                    "moment" in window || k.error("MissingLibrary", "MomentJS is required for Date/Time validation. Get it here http://momentjs.com");
                    var n = moment(d[l], h.format);
                    if (!n.isValid()) {
                      i = [this.getValidationMessage(h, "format", "datetime_invalid"), h.format];
                      break
                    }
                    if (h.min && n < moment(h.min, h.format)) {
                      i = [this.getValidationMessage(h, "min", "datetime_exceed_min"), h.min];
                      break
                    }
                    if (h.max && n > moment(h.max, h.format)) {
                      i = [this.getValidationMessage(h, "max", "datetime_exceed_max"), h.max];
                      break
                    }
                  }
                  break;
                case "boolean":
                  if (void 0 === d[l] || 0 === d[l].length) {
                    h.allow_empty_value || (i = ["boolean_not_valid"]);
                    break
                  }
      ...
      return k.error(b !== !1, "UndefinedFilter", 'Undefined filter "{0}"', a), null
      ...
      return k.error(b !== !1, "UndefinedOperator", 'Undefined operator "{0}"', a), null
      ...
      if (b.valueGetter) d = b.valueGetter.call(this, a);
        ...
        for (var e = a.$el.find(g.selectors.value_container), f = 0; f < c.nb_inputs; f++) {
          var h, i = k.escapeElementId(a.id + "_value_" + f);
          switch (b.input) {
            case "radio":
              d.push(e.find("[name=" + i + "]:checked").val());
              break;
            case "checkbox":
              h = [], e.find("[name=" + i + "]:checked").each(function () {
                h.push($(this).val())
              }), d.push(h);
              break;
            case "select":
              b.multiple ? (h = [], e.find("[name=" + i + "] option:selected").each(function () {
                h.push($(this).val())
              }), d.push(h)) : d.push(e.find("[name=" + i + "] option:selected").val());
              break;
            default:
      ...
      if (c && d) {
        if (this._updating_input = !0, c.valueSetter) c.valueSetter.call(this, a, b);
          ...
          for (var f = 0; f < d.nb_inputs; f++) {
            var h = k.escapeElementId(a.id + "_value_" + f);
            switch (c.input) {
              case "radio":
                e.find("[name=" + h + '][value="' + b[f] + '"]').prop("checked", !0).trigger("change");
                break;
              case "checkbox":
                $.isArray(b[f]) || (b[f] = [b[f]]), b[f].forEach(function (a) {
                  e.find("[name=" + h + '][value="' + a + '"]').prop("checked", !0).trigger("change")
                });
                break;
              default:
                d.multiple && c.value_separator && $.isArray(b[f]) && (b[f] = b[f].join(c.value_separator)), e.find("[name=" + h + "]").val(b[f]).trigger("change")
            }
          }
        }
    ...
    g.prototype.getGroupTemplate = function (a, b) {
      ...
      if ("function" == typeof c.input) g = c.input.call(this, a, e);
        ...
        case "radio":
        case "checkbox":
          k.iterateOptions(c.values, function (a, b) {
            g += "<label" + f + '><input type="' + c.input + '" name="' + e + '" value="' + a + '"> ' + b + "</label> "
          });
          break;
        case "select":
          g += '<select class="form-control" name="' + e + '"' + (c.multiple ? " multiple" : "") + ">", c.placeholder && (g += '<option value="' + c.placeholder_value + '" disabled selected>' + c.placeholder + "</option>"), k.iterateOptions(c.values, function (a, b) {
  ...
  var h = function (a, b) {
    return this instanceof h ? (Object.defineProperty(this, "__", {
      value: {}
    }), b.data("queryBuilderModel", this), this.__.level = 1, this.__.error = null, this.__.flags = {}, this.__.data = void 0, this.$el = b, this.id = b[0].id, this.model = null, void(this.parent = a)) : new h(a, b)
  };
  b.defineModelProperties(h, ["level", "error", "data", "flags"]), Object.defineProperty(h.prototype, "parent", {
    enumerable: !0,
    get: function () {
  ...
  var i = function (a, b) {
    return this instanceof i ? (h.call(this, a, b), this.rules = [], void(this.__.condition = null)) : new i(a, b)
  };
  i.prototype = Object.create(h.prototype), i.prototype.constructor = i, b.defineModelProperties(i, ["condition"]), i.prototype.empty = function () {
    ...
    this.empty(), h.prototype.drop.call(this)
  }, i.prototype.length = function () {
    return this.rules.length
  }, i.prototype.insertNode = function (a, b, c) {
    return void 0 === b && (b = this.length()), this.rules.splice(b, 0, a), a.parent = this, c && null !== this.model && this.model.trigger("add", this, a, b), a
  }, i.prototype.addGroup = function (a, b) {
    return this.insertNode(new i(this, a), b, !0)
  }, i.prototype.addRule = function (a, b) {
    return this.insertNode(new j(this, a), b, !0)
  }, i.prototype.removeNode = function (a) {
    var b = this.getNodePos(a);
    b !== -1 && (a.parent = null, this.rules.splice(b, 1))
  }, i.prototype.getNodePos = function (a) {
    return this.rules.indexOf(a)
  }, i.prototype.each = function (a, b, c, d) {
    ...
    for (var e = a ? this.rules.length - 1 : 0, f = a ? 0 : this.rules.length - 1, g = a ? -1 : 1, h = function () {
        return a ? e >= f : e <= f
      }, j = !1; h() && (this.rules[e] instanceof i ? c && (j = c.call(d, this.rules[e]) === !1) : b && (j = b.call(d, this.rules[e]) === !1), !j); e += g);
    return !j
  }, i.prototype.contains = function (a, b) {
    return this.getNodePos(a) !== -1 || !!b && !this.each(function () {
      return !0
    }, function (b) {
  ...
  var j = function (a, b) {
    return this instanceof j ? (h.call(this, a, b), this._updating_value = !1, this._updating_input = !1, this.__.filter = null, this.__.operator = null, void(this.__.value = void 0)) : new j(a, b)
  };
  j.prototype = Object.create(h.prototype), j.prototype.constructor = j, b.defineModelProperties(j, ["filter", "operator", "value"]), j.prototype.isRoot = function () {
    return !1
  }, g.Group = i, g.Rule = j;
  var k = {};
  g.utils = k, k.iterateOptions = function (a, b) {
    ...
    if (b) {
      var f = new Error(k.fmt(d, e));
      throw f.name = c + "Error", f.args = e, f
    }
    console.error(c + "Error: " + k.fmt(d, e))
  }, k.changeType = function (a, b, c) {
    switch (b) {
      case "integer":
        return parseInt(a);
      case "double":
  ...
  }, k.escapeRegExp = function (a) {
    return a.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&")
  }, k.escapeElementId = function (a) {
    return a ? a.replace(/(\\)?([:.\[\],])/g, function (a, b, c) {
      return b ? a : "\\" + c
    }) : a
  }, k.groupSort = function (a, b) {
    var c = [],
      d = [];
    ...
    0 === this.length && k.error("Config", "No target defined"), this.length > 1 && k.error("Config", "Unable to initialize on multiple target");
    ...
    "glyphicons" == a.font && this.$el.addClass("bt-checkbox-glyphicons"), this.on("getRuleInput.filter", function (b, c, d) {
      ...
      if (("radio" === e.input || "checkbox" === e.input) && !e.plugin) {
        ...
        var f = e.vertical ? ' style="display:block"' : "",
          g = 0;
        k.iterateOptions(e.values, function (c, h) {
    ...
    $.fn.selectpicker && $.fn.selectpicker.Constructor || k.error("MissingLibrary", 'Bootstrap Select is required to use "bt-selectpicker" plugin. Get it here: http://silviomoreto.github.io/bootstrap-select');
    var b = g.selectors;
    ...
    $.fn.tooltip && $.fn.tooltip.Constructor && $.fn.tooltip.Constructor.prototype.fixTitle || k.error("MissingLibrary", 'Bootstrap Tooltip is required to use "bt-tooltip-errors" plugin. Get it here: http://getbootstrap.com');
    var b = this;
    ...
    setFilters: function (a, b) {
      ...
      if (a || ! function f(a) {
          a.each(function (a) {
            a.filter && d.indexOf(a.filter.id) === -1 && k.error("ChangeFilter", 'A rule is using filter "{0}"', a.filter.id)
          }, f)
        }(this.model.root), this.filters = b, function h(a) {
          a.each(!0, function (a) {
            a.filter && d.indexOf(a.filter.id) === -1 ? a.drop() : (c.createRuleFilters(a), a.$el.find(g.selectors.rule_filter).val(a.filter ? a.filter.id : "-1"), c.trigger("afterUpdateRuleFilter", a))
          }, h)
    ...
    }) : "popover" === a.mode ? ($.fn.popover && $.fn.popover.Constructor && $.fn.popover.Constructor.prototype.fixTitle || k.error("MissingLibrary", 'Bootstrap Popover is required to use "filter-description" plugin. Get it here: http://getbootstrap.com'), this.on("afterUpdateRuleFilter afterUpdateRuleOperator", function (b, c) {
    ...
    })) : "bootbox" === a.mode && ("bootbox" in window || k.error("MissingLibrary", 'Bootbox is required to use "filter-description" plugin. Get it here: http://bootboxjs.com'), this.on("afterUpdateRuleFilter afterUpdateRuleOperator", function (b, c) {
      var d = c.$el.find("button.filter-description"),
        e = b.builder.getFilterDescription(c.filter, c);
    ...
    invert: function (a, b) {
      ...
      if ("object" != typeof b && (b = {}), void 0 === b.recursive && (b.recursive = !0), void 0 === b.invert_rules && (b.invert_rules = !0), void 0 === b.silent_fail && (b.silent_fail = !1), void 0 === b.trigger && (b.trigger = !0), a instanceof i) {
        if (this.settings.conditionOpposites[a.condition] ? a.condition = this.settings.conditionOpposites[a.condition] : b.silent_fail || k.error("InvertCondition", 'Unknown inverse of condition "{0}"', a.condition), b.recursive) {
          var c = $.extend({}, b, {
            trigger: !1
          });
          a.each(function (a) {
      ...
      } else if (a instanceof j && a.operator && !a.filter.no_invert)
        ...
        } else b.silent_fail || k.error("InvertOperator", 'Unknown inverse of operator "{0}"', a.operator.type);
    ...
    getMongo: function (a) {
      ...
      var b = this;
      return function c(a) {
        if (a.condition || (a.condition = b.settings.default_condition), ["AND", "OR"].indexOf(a.condition.toUpperCase()) === -1 && k.error("UndefinedMongoCondition", 'Unable to build MongoDB query with condition "{0}"', a.condition), !a.rules) return {};
        var d = [];
        a.rules.forEach(function (a) {
          if (a.rules && a.rules.length > 0) d.push(c(a));
            ...
            var e = b.settings.mongoOperators[a.operator],
              ...
              g = [];
            void 0 === e && k.error("UndefinedMongoOperator", 'Unknown MongoDB operation for operator "{0}"', a.operator), 0 !== f.nb_inputs && (a.value instanceof Array || (a.value = [a.value]), a.value.forEach(function (b) {
              g.push(k.changeType(b, a.type, !1))
            }));
            var h = b.change("getMongoDBField", a.field, a),
              i = {};
            i[h] = e.call(b, g), d.push(b.change("ruleToMongo", i, a, g, e))
          }
        });
        var e = {};
    ...
    getRulesFromMongo: function (a) {
      ...
      var e = d(a);
      return e || k.error("MongoParse", "Invalid MongoDB query format"),
        function f(a, e) {
          var g = a[e],
            h = [];
          return g.forEach(function (a) {
            ...
            if (e) h.push(f(a, e));
              ...
              var g = Object.keys(a)[0],
                i = a[g],
                j = c(i, g);
              void 0 === j && k.error("MongoParse", "Invalid MongoDB query format");
              var l = b.settings.mongoRuleOperators[j];
              void 0 === l && k.error("UndefinedMongoOperator", 'JSON Rule operation unknown for operator "{0}"', j);
              var m = l.call(b, i),
                n = b.getMongoDBFieldID(g, i),
    ...
    this.on("afterInit", function () {
      b.$el.on("click.queryBuilder", "[data-not=group]", function () {
        ...
        c instanceof i && "not" === d && b.updateGroupNot(c)
      })
  ...
  }), b.defineModelProperties(i, ["not"]), g.selectors.group_not = g.selectors.group_header + " [data-not=group]", g.extend({
    ...
    this.on("afterAddRule afterAddGroup", function (f, h) {
      if (h != b) {
        ...
        a.inherit_no_sortable && h.parent && h.parent.flags.no_sortable && (h.flags.no_sortable = !0), a.inherit_no_drop && h.parent && h.parent.flags.no_drop && (h.flags.no_drop = !0), h.flags.no_sortable || interact(h.$el[0]).allowFrom(g.selectors.drag_handle).draggable({
          onstart: function (a) {
            d = j.getModel(a.target), c = d.$el.clone().appendTo(d.$el.parent()).width(d.$el.outerWidth()).addClass("dragging");
          ...
          onend: function () {
            c.remove(), c = void 0, b.drop(), b = void 0, d.$el.show(), j.trigger("afterMove", d)
          }
        ...
        }), h instanceof i && interact(h.$el.find(g.selectors.group_header)[0]).dropzone({
          accept: g.selectors.rule_and_group_containers,
          ondragenter: function (a) {
            e(b, $(a.target), j)
          },
      ...
      a.isDefaultPrevented() || (interact(b.$el[0]).unset(), b instanceof i && interact(b.$el.find(g.selectors.group_header)[0]).unset())
    ...
    sqlRuleOperator: {
      ...
      LIKE: function (a) {
        return "%" == a.slice(0, 1) && "%" == a.slice(-1) ? {
          ...
          val: a.slice(0, -1),
          op: "begins_with"
        } : void k.error("SQLParse", 'Invalid value for LIKE operator "{0}"', a)
      },
      "NOT LIKE": function (a) {
        return "%" == a.slice(0, 1) && "%" == a.slice(-1) ? {
          val: a.slice(1, -1),
          ...
          val: a.slice(0, -1),
          op: "not_begins_with"
        } : void k.error("SQLParse", 'Invalid value for NOT LIKE operator "{0}"', a)
      },
      IN: function (a) {
        return {
          val: a,
      ...
      IS: function (a) {
        return null !== a && k.error("SQLParse", "Invalid value for IS operator"), {
          val: null,
          op: "is_null"
        }
      },
    ...
    getSQL: function (a, b, c) {
      if (c = void 0 === c ? this.getRules() : c, b = b ? "\n" : " ", a === !0 && (a = "question_mark"), "string" == typeof a) {
        var d = f(a);
        a = this.settings.sqlStatements[d[1]](d[2])
      }
      var e = this,
        g = function h(c) {
          if (c.condition || (c.condition = e.settings.default_condition), ["AND", "OR"].indexOf(c.condition.toUpperCase()) === -1 && k.error("UndefinedSQLCondition", 'Unable to build SQL query with condition "{0}"', c.condition), !c.rules) return "";
          var d = [];
          c.rules.forEach(function (c) {
            if (c.rules && c.rules.length > 0) d.push("(" + b + h(c) + b + ")" + b);
              ...
              var f = e.settings.sqlOperators[c.operator],
                ...
                i = "";
              void 0 === f && k.error("UndefinedSQLOperator", 'Unknown SQL operation for operator "{0}"', c.operator), 0 !== g.nb_inputs && (c.value instanceof Array || (c.value = [c.value]), c.value.forEach(function (b, d) {
                d > 0 && (i += f.sep), "integer" == c.type || "double" == c.type || "boolean" == c.type ? b = k.changeType(b, c.type, !0) : a || (b = k.escapeString(b)), f.mod && (b = k.fmt(f.mod, b)), a ? i += a.add(c, b) : ("string" == typeof b && (b = "'" + b + "'"), i += b)
              }));
              var j = function (a) {
                  return f.op.replace(/\?/, a)
                },
                l = e.change("getSQLField", c.field, c),
                m = l + " " + j(i);
              d.push(e.change("ruleToSQL", m, c, i, j))
            }
          });
    ...
    getRulesFromSQL: function (a, b) {
      "SQLParser" in window || k.error("MissingLibrary", "SQLParser is required to parse SQL queries. Get it here https://github.com/mistic100/sql-parser");
      var c = this;
      ...
      e.where || k.error("SQLParse", "No WHERE clause found");
      ...
      var h = c.change("sqlToGroup", {
          condition: this.settings.default_condition,
          rules: []
        }, g),
        i = h;
      return function j(a, d) {
        if (a = c.change("parseSQLNode", a), "rules" in a && "condition" in a) return void i.rules.push(a);
        if ("id" in a && "operator" in a && "value" in a) return void i.rules.push(a);
        if ("left" in a && "right" in a && "operation" in a || k.error("SQLParse", "Unable to parse WHERE clause"), ["AND", "OR"].indexOf(a.operation.toUpperCase()) !== -1) {
          if (d > 0 && i.condition != a.operation.toUpperCase()) {
          ...
          i.condition = a.operation.toUpperCase(), d++;
          var f = i;
          j(a.left, d), i = f, j(a.right, d)
        } else {
          $.isPlainObject(a.right.value) && k.error("SQLParse", "Value format not supported for {0}.", a.left.value);
          var g;
          g = $.isArray(a.right.value) ? a.right.value.map(function (a) {
            return a.value
          }) : a.right.value, b && (g = $.isArray(g) ? g.map(b.parse) : b.parse(g));
          var h = a.operation.toUpperCase();
          "<>" == h && (h = "!=");
          var l = c.settings.sqlRuleOperator[h];
          void 0 === l && k.error("UndefinedSQLOperator", 'Invalid SQL operation "{0}".', a.operation);
          var m, n = l.call(this, g, a.operation);
          "values" in a.left ? m = a.left.values.join(".") : "value" in a.left ? m = a.left.value : k.error("SQLParse", "Cannot find field name in {0}", JSON.stringify(a.left));
    ...
    this.status.used_filters = {}, this.on("afterUpdateRuleFilter", this.updateDisabledFilters), this.on("afterDeleteRule", this.updateDisabledFilters), this.on("afterCreateRuleFilters", this.applyDisabledFilters), this.on("afterReset", this.clearDisabledFilters), this.on("afterClear", this.clearDisabledFilters), this.on("getDefaultFilter.filter", function (a, b) {
      ...
      if (c.updateDisabledFilters(), a.value.id in c.status.used_filters) {
        ...
        d || (k.error(!1, "UniqueFilter", "No more non-unique filters available"), a.value = void 0)
      }
    })
  }), g.extend({
